...
class OllamaModelTester:
    ...
    def __init__(self, api_base_url: str, prompt: str):
        """
        ...
        Raises:
            ...
            ValueError: If no models are found on the server.
        """
...
if __name__ == "__main__":
    try:
        ...
        tester = OllamaModelTester(api_base_url="http://localhost:11434", prompt="Hello, who are you?"*1000)
